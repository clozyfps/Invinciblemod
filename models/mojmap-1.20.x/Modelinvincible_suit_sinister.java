...
public class Modelinvincible_suit_sinister<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "invincible_suit_sinister"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition torso_r1 = Body.addOrReplaceChild("torso_r1",
				CubeListBuilder.create().texOffs(64, 0).addBox(-7.5F, -11.0F, -1.0F, 15.0F, 22.0F, 2.0F,
						new CubeDeformation(0.261F)),
