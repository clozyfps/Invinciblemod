...
import net.mcreator.invincible.procedures.UseAbilityKey5Procedure;
...
public class UseAbility5Message {
	...
	public static void pressAction(Player entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			UseAbilityKey5Procedure.execute(world, x, y, z, entity);
		}
		if (type == 1) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		InvincibleMod.addNetworkMessage(UseAbility5Message.class, UseAbility5Message::buffer, UseAbility5Message::new, UseAbility5Message::handler);
	}
}
