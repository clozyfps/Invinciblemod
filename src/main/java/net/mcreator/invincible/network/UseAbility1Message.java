...
import net.mcreator.invincible.procedures.UseAbilityKey1Procedure;
...
public class UseAbility1Message {
	...
	public static void pressAction(Player entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			UseAbilityKey1Procedure.execute(world, x, y, z, entity);
		}
		if (type == 1) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		InvincibleMod.addNetworkMessage(UseAbility1Message.class, UseAbility1Message::buffer, UseAbility1Message::new, UseAbility1Message::handler);
	}
}
