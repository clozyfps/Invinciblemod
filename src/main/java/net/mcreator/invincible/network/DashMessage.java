...
import net.mcreator.invincible.procedures.DashOnKeyPressedProcedure;
...
public class DashMessage {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		InvincibleMod.addNetworkMessage(DashMessage.class, DashMessage::buffer, DashMessage::new, DashMessage::handler);
	}
}
