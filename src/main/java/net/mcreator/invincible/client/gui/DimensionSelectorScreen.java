...
import net.mcreator.invincible.procedures.ReturnUnlockedSnowProcedure;
import net.mcreator.invincible.procedures.ReturnUnlockedNetherProcedure;
import net.mcreator.invincible.procedures.ReturnUnlockedFlaxanProcedure;
import net.mcreator.invincible.procedures.ReturnUnlockedEndProcedure;
import net.mcreator.invincible.procedures.ReturnUnlockedDesertProcedure;
import net.mcreator.invincible.procedures.ReturnUnlockedApocalytpicProcedure;
import net.mcreator.invincible.procedures.ReturnNameSnowProcedure;
import net.mcreator.invincible.procedures.ReturnNameNetherProcedure;
import net.mcreator.invincible.procedures.ReturnNameFlaxanProcedure;
import net.mcreator.invincible.procedures.ReturnNameEndProcedure;
import net.mcreator.invincible.procedures.ReturnNameDesertProcedure;
import net.mcreator.invincible.procedures.ReturnNameApocalypticProcedure;
import net.mcreator.invincible.procedures.ReturnLockedSnowProcedure;
import net.mcreator.invincible.procedures.ReturnLockedNetherProcedure;
import net.mcreator.invincible.procedures.ReturnLockedFlaxanProcedure;
import net.mcreator.invincible.procedures.ReturnLockedEndProcedure;
...
public class DimensionSelectorScreen extends AbstractContainerScreen<DimensionSelectorMenu> implements WidgetScreen {
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int gx, int gy) {
		...
		if (ReturnUnlockedApocalytpicProcedure.execute(entity)) {
