...
public class StatsMenuScreen extends AbstractContainerScreen<StatsMenuMenu> {
	...
	public void render(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
		...
		ReturnPlayerEntityProcedure.execute(entity)
		...
		if (mouseX > leftPos + -82 && mouseX < leftPos + 80 && mouseY > topPos + -51 && mouseY < topPos + -42)
			guiGraphics.renderTooltip(font, Component.literal(
					...
					ReturnEXPAmountProcedure.execute(entity)), mouseX, mouseY);
		if (mouseX > leftPos + -82 && mouseX < leftPos + 80 && mouseY > topPos + 66 && mouseY < topPos + 75)
			guiGraphics.renderTooltip(font, Component.literal(

					ReturnMasteryAmountProcedure.execute()), mouseX, mouseY);
	}
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int gx, int gy) {
		...
		ReturnShowEXPProcedure.execute(entity)

		) {
			guiGraphics.blit(new ResourceLocation("invincible:textures/screens/exp_bar.png"), this.leftPos + -81, this.topPos + -50, Mth.clamp((int)

			ReturnEXPProcedure.execute(entity) * 160, 0, 2400), 0, 160, 7, 2560, 7);
		}
		if (

		ReturnShowMasteryProcedure.execute()

		) {
			guiGraphics.blit(new ResourceLocation("invincible:textures/screens/exp_bar.png"), this.leftPos + -81, this.topPos + 67, Mth.clamp((int)

			ReturnMasteryProcedure.execute() * 160, 0, 2400), 0, 160, 7, 2560, 7);
		}
