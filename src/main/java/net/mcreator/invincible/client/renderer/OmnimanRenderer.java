...
import net.mcreator.invincible.entity.model.OmnimanModel;
...
public class OmnimanRenderer extends GeoEntityRenderer<OmnimanEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, OmnimanEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green,
