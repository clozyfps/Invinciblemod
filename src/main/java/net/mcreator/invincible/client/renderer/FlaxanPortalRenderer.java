...
import net.mcreator.invincible.entity.model.FlaxanPortalModel;
...
public class FlaxanPortalRenderer extends GeoEntityRenderer<FlaxanPortalEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, FlaxanPortalEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green,
