...
public class Modelveil_invincible_suit<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("invincible", "modelveil_invincible_suit"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head = partdefinition
				.addOrReplaceChild("Head",
						CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.51F)).texOffs(0, 61).addBox(-3.35F, -3.85F, -4.75F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.25F)).texOffs(0, 61)
								.mirror().addBox(1.35F, -3.85F, -4.75F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.25F)).mirror(false).texOffs(32, 52).addBox(-4.0F, 0.5F, -4.0F, 8.0F, 4.0F, 8.0F, new CubeDeformation(0.25F)),
		...
		PartDefinition LeftLeg = partdefinition.addOrReplaceChild("LeftLeg", CubeListBuilder.create().texOffs(24, 32).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.27F)), PartPose.offset(2.0F, 12.0F, 0.0F));
		PartDefinition RightLeg = partdefinition.addOrReplaceChild("RightLeg", CubeListBuilder.create().texOffs(24, 32).mirror().addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.27F)).mirror(false),
