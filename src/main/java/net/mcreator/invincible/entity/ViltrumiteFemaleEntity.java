...
public class ViltrumiteFemaleEntity extends Monster implements GeoEntity {
	...
	public static void init() {
		SpawnPlacements.register(InvincibleModEntities.VILTRUMITE_FEMALE.get(), SpawnPlacements.Type.NO_RESTRICTIONS, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, Mob::checkMobSpawnRules);
	}
