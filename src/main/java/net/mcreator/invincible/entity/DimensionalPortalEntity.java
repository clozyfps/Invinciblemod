...
public class DimensionalPortalEntity extends TamableAnimal implements GeoEntity {
	...
	public DimensionalPortalEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(InvincibleModEntities.DIMENSIONAL_PORTAL.get(), world);
	}

	public DimensionalPortalEntity(EntityType<DimensionalPortalEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setMaxUpStep(0.6f);
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		DimensionalPortalEntity retval = InvincibleModEntities.DIMENSIONAL_PORTAL.get().create(serverWorld);
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(DimensionalPortalEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
