...
public class MaulerModel extends GeoModel<MaulerEntity> {
	...
	public ResourceLocation getAnimationResource(MaulerEntity entity) {
		return new ResourceLocation("invincible", "animations/mauler.animation.json");
	}

	@Override
	public ResourceLocation getModelResource(MaulerEntity entity) {
		return new ResourceLocation("invincible", "geo/mauler.geo.json");
	}
	...
	@Override
	public void setCustomAnimations(MaulerEntity animatable, long instanceId, AnimationState animationState) {
