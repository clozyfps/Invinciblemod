...
public class FlaxanGunmanEntity extends TamableAnimal implements RangedAttackMob, GeoEntity {
	...
	public FlaxanGunmanEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(InvincibleModEntities.FLAXAN_GUNMAN.get(), world);
	}

	public FlaxanGunmanEntity(EntityType<FlaxanGunmanEntity> type, Level world) {
		super(type, world);
		xpReward = 10;
		setNoAi(false);
		setMaxUpStep(0.6f);
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "flaxan_gunman");
	}
	...
	public class RangedAttackGoal extends Goal {
		...
		public void stop() {
			...
			this.seeTime = 0;
			this.attackTime = -1;
			((FlaxanGunmanEntity) rangedAttackMob).entityData.set(SHOOT, false);
		}
		...
		public void tick() {
			...
			if (--this.attackTime == 0) {
				...
				((FlaxanGunmanEntity) rangedAttackMob).entityData.set(SHOOT, true);
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		FlaxanGunmanEntity retval = InvincibleModEntities.FLAXAN_GUNMAN.get().create(serverWorld);
	...
	public static void init() {
		SpawnPlacements.register(InvincibleModEntities.FLAXAN_GUNMAN.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
