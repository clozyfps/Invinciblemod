...
public class ViltrumiteEntity extends Monster implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(ViltrumiteEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(ViltrumiteEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(ViltrumiteEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<Integer> DATA_malevilapp = SynchedEntityData.defineId(ViltrumiteEntity.class, EntityDataSerializers.INT);
	...
	public ViltrumiteEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(InvincibleModEntities.VILTRUMITE.get(), world);
	}
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(ViltrumiteEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
