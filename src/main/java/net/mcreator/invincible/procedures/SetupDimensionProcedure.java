...
public class SetupDimensionProcedure {
	public static abstract class InvincibleModDimensionSpecialEffects extends DimensionSpecialEffects {
		...
		public InvincibleModDimensionSpecialEffects(float cloudHeight, boolean hasGround, DimensionSpecialEffects.SkyType skyType, boolean forceBrightLightmap, boolean constantAmbientLight) {
	...
	public static void register(String name, DimensionSpecialEffects effects) {
		provider.register(new ResourceLocation("invincible", name), effects);
	}
	...
	public static DimensionSpecialEffects createOverworldEffects(final boolean constantWhiteLight, final boolean constantAmbientLight, final boolean fog) {
		return new InvincibleModDimensionSpecialEffects(192.0F, true, DimensionSpecialEffects.SkyType.NORMAL, constantWhiteLight, constantAmbientLight) {
			@Override
	...
	public static DimensionSpecialEffects createNetherEffects(final boolean constantWhiteLight, final boolean constantAmbientLight, final boolean fog) {
		return new InvincibleModDimensionSpecialEffects(Float.NaN, true, DimensionSpecialEffects.SkyType.NONE, constantWhiteLight, constantAmbientLight) {
			@Override
			public Vec3 getBrightnessDependentFogColor(Vec3 color, float sunHeight) {
				return color;
			}
	...
	public static DimensionSpecialEffects createEndEffects(final boolean constantWhiteLight, final boolean constantAmbientLight, final boolean fog) {
		return new InvincibleModDimensionSpecialEffects(Float.NaN, false, DimensionSpecialEffects.SkyType.END, constantWhiteLight, constantAmbientLight) {
			@Override
			public Vec3 getBrightnessDependentFogColor(Vec3 color, float sunHeight) {
	...
	private static void execute(@Nullable Event event) {
		register(ResourceKey.create(Registries.DIMENSION, new ResourceLocation("invincible:space")), createOverworldEffects(false, false, false));
	}
}
