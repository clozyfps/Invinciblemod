					...
					for (int zi = -horizontalRadiusSphere; zi <= horizontalRadiusSphere; zi++) {
						...
						if (distanceSq <= 1.0) {
							if (!((world.getBlockState(
									BlockPos.containing((entity.getX() + entity.getLookAngle().x * 3) + xi, (entity.getY() + entity.getEyeHeight() + entity.getLookAngle().y * 3) + i, (entity.getZ() + entity.getLookAngle().z * 3) + zi)))
									.getBlock() == Blocks.AIR)) {
								world.destroyBlock(BlockPos.containing((entity.getX() + entity.getLookAngle().x * 3) + xi, (entity.getY() + entity.getEyeHeight() + entity.getLookAngle().y * 3) + i, (entity.getZ() + entity.getLookAngle().z * 3) + zi),
										false);
							}
						}
					}
