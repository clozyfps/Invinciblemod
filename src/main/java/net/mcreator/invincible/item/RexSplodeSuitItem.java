...
public abstract class RexSplodeSuitItem extends ArmorItem {
	...
	public static class Helmet extends RexSplodeSuitItem {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "invincible:textures/entities/rex_splode_suit.png";
		}
	}
	...
	public static class Chestplate extends RexSplodeSuitItem {
		...
		public void initializeClient(Consumer<IClientItemExtensions> consumer) {
			consumer.accept(new IClientItemExtensions() {
				...
				@OnlyIn(Dist.CLIENT)
				public HumanoidModel getHumanoidArmorModel(LivingEntity living, ItemStack stack, EquipmentSlot slot, HumanoidModel defaultModel) {
					HumanoidModel armorModel = new HumanoidModel(new ModelPart(Collections.emptyList(), Map.of("body", new Modelrex_splode_suit(Minecraft.getInstance().getEntityModels().bakeLayer(Modelrex_splode_suit.LAYER_LOCATION)).Body,
							"left_arm", new Modelrex_splode_suit(Minecraft.getInstance().getEntityModels().bakeLayer(Modelrex_splode_suit.LAYER_LOCATION)).LeftArm, "right_arm",
