...
public abstract class InvincibleBlueSuitItem extends ArmorItem {
	public InvincibleBlueSuitItem(ArmorItem.Type type, Item.Properties properties) {
	...
	public static class Helmet extends InvincibleBlueSuitItem {
		public Helmet() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "invincible:textures/entities/invinciblue_suit.png";
		}
	}

	public static class Chestplate extends InvincibleBlueSuitItem {
		public Chestplate() {
	...
	public static class Leggings extends InvincibleBlueSuitItem {
		public Leggings() {
	...
	public static class Boots extends InvincibleBlueSuitItem {
		public Boots() {
