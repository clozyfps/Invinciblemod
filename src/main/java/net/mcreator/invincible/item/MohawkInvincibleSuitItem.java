...
public abstract class MohawkInvincibleSuitItem extends ArmorItem {
	public MohawkInvincibleSuitItem(ArmorItem.Type type, Item.Properties properties) {
	...
	public static class Chestplate extends MohawkInvincibleSuitItem {
		public Chestplate() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "invincible:textures/entities/mohawk_invincible_suit.png";
		}
	}

	public static class Leggings extends MohawkInvincibleSuitItem {
		public Leggings() {
	...
	public static class Boots extends MohawkInvincibleSuitItem {
		public Boots() {
