...
public abstract class AngstromSuitItem extends ArmorItem {
	public AngstromSuitItem(ArmorItem.Type type, Item.Properties properties) {
	...
	public static class Helmet extends AngstromSuitItem {
		public Helmet() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "invincible:textures/entities/angstrom_clothes.png";
		}
	}

	public static class Chestplate extends AngstromSuitItem {
		public Chestplate() {
		...
		public void initializeClient(Consumer<IClientItemExtensions> consumer) {
			consumer.accept(new IClientItemExtensions() {
				...
				@OnlyIn(Dist.CLIENT)
				public HumanoidModel getHumanoidArmorModel(LivingEntity living, ItemStack stack, EquipmentSlot slot, HumanoidModel defaultModel) {
					HumanoidModel armorModel = new HumanoidModel(new ModelPart(Collections.emptyList(), Map.of("body", new Modelangstrom_clothes(Minecraft.getInstance().getEntityModels().bakeLayer(Modelangstrom_clothes.LAYER_LOCATION)).Body,
							"left_arm", new Modelangstrom_clothes(Minecraft.getInstance().getEntityModels().bakeLayer(Modelangstrom_clothes.LAYER_LOCATION)).LeftArm, "right_arm",
	...
	public static class Leggings extends AngstromSuitItem {
		public Leggings() {
	...
	public static class Boots extends AngstromSuitItem {
		public Boots() {
