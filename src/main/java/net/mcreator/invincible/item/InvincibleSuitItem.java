...
public abstract class InvincibleSuitItem extends ArmorItem {
	public InvincibleSuitItem(ArmorItem.Type type, Item.Properties properties) {
	...
	public static class Helmet extends InvincibleSuitItem {
		public Helmet() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "invincible:textures/entities/invincible_suit.png";
		}
	}

	public static class Chestplate extends InvincibleSuitItem {
		public Chestplate() {
	...
	public static class Leggings extends InvincibleSuitItem {
		public Leggings() {
	...
	public static class Boots extends InvincibleSuitItem {
		public Boots() {
