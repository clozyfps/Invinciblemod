...
public abstract class MaskedInvincibleSuitItem extends ArmorItem {
	public MaskedInvincibleSuitItem(ArmorItem.Type type, Item.Properties properties) {
	...
	public static class Helmet extends MaskedInvincibleSuitItem {
		public Helmet() {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "invincible:textures/entities/dark_invincible_suit.png";
		}
	}

	public static class Chestplate extends MaskedInvincibleSuitItem {
		public Chestplate() {
		...
		public void initializeClient(Consumer<IClientItemExtensions> consumer) {
			consumer.accept(new IClientItemExtensions() {
				...
				@OnlyIn(Dist.CLIENT)
				public HumanoidModel getHumanoidArmorModel(LivingEntity living, ItemStack stack, EquipmentSlot slot, HumanoidModel defaultModel) {
					HumanoidModel armorModel = new HumanoidModel(new ModelPart(Collections.emptyList(), Map.of("body", new Modelinvincible_suit(Minecraft.getInstance().getEntityModels().bakeLayer(Modelinvincible_suit.LAYER_LOCATION)).Body,
							"left_arm", new Modelinvincible_suit(Minecraft.getInstance().getEntityModels().bakeLayer(Modelinvincible_suit.LAYER_LOCATION)).LeftArm, "right_arm",
	...
	public static class Leggings extends MaskedInvincibleSuitItem {
		public Leggings() {
	...
	public static class Boots extends MaskedInvincibleSuitItem {
		public Boots() {
