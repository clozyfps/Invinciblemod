...
public class InvincibleModSounds {
	...
	public static final RegistryObject<SoundEvent> SLICEBLOOD = REGISTRY.register("sliceblood", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation("invincible", "sliceblood")));
}
