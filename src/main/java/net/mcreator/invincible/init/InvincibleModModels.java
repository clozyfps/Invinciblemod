...
import net.mcreator.invincible.client.model.Modelrobo_ball;
...
import net.mcreator.invincible.client.model.ModelAtomWall;
...
public class InvincibleModModels {
	...
	public static void registerLayerDefinitions(EntityRenderersEvent.RegisterLayerDefinitions event) {
		...
		event.registerLayerDefinition(ModelAtomWall.LAYER_LOCATION, ModelAtomWall::createBodyLayer);
