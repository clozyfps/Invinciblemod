...
public class ViltrumBiomeTrunkDecorator extends TrunkVineDecorator {
	public static Codec<ViltrumBiomeTrunkDecorator> CODEC = Codec.unit(ViltrumBiomeTrunkDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(ForgeRegistries.Keys.TREE_DECORATOR_TYPES, registerHelper -> registerHelper.register("viltrum_biome_tree_trunk_decorator", DECORATOR_TYPE));
	}
