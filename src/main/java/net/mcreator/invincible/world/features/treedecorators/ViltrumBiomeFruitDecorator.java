...
package net.mcreator.invincible.world.features.treedecorators;
...
public class ViltrumBiomeFruitDecorator extends CocoaDecorator {
	public static Codec<ViltrumBiomeFruitDecorator> CODEC = Codec.unit(ViltrumBiomeFruitDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(ForgeRegistries.Keys.TREE_DECORATOR_TYPES, registerHelper -> registerHelper.register("viltrum_biome_tree_fruit_decorator", DECORATOR_TYPE));
	}

	public ViltrumBiomeFruitDecorator() {
		super(0.2f);
	}
